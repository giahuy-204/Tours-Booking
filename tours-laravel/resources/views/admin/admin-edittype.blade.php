...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="mt-2 font-weight-bold text-primary" style="float: left">Edit Type </h6>
        </div>
        <div class="card-body">
                ...
                <div class="form" style="margin: 0 20px 20px 20px">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="typeName" name="typeName" value = "{{$type->name}}">
                        </div>
                        <div class="form-group">
                            <label for="shortDes">Type image</label>
                            <input class="form-control" type="file" id="typeImage" name="typeImage">
                        </div>
                        <div class="form-group">
                        ...
                        <button class="btn btn-primary" type="submit" style="width: 100%">EDIT TYPE</button>
                    </form>
                </div>
            </div>
        </div>
